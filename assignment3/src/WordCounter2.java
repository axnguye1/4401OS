...
public class WordCounter2 {
    public static void main(String[] args) {
        ...
        Map<String, Integer> wordsSixMap = new ConcurrentHashMap<>();
        Map<String, Integer> wordsSevenMap = new ConcurrentHashMap<>();
        Map<String, Integer> wordsEightMap = new ConcurrentHashMap<>();
    ...
    private static String findMostFrequentWord(Map<String, Integer> wordFrequencyMap) {
        // Make a copy of map to avoid any changes when filtering.
        Map<String, Integer> copyMap = new HashMap<>(wordFrequencyMap);
